...
_ITEMS_TO_DESCRIPTIONS = {
        ...
        # 'image_raw_A_seg': 'image_raw_A_seg.',
        # 'image_raw_B_seg': 'image_raw_B_seg.',
        # 'image_raw_A_seg_class': 'image_raw_A_seg_class.',
        # 'image_raw_B_seg_class': 'image_raw_B_seg_class.',
...
def get_split(split_name, data_dir, data_name='gta', img_height=256, img_width=512, seg_class=8, file_pattern=None, reader=None):
    ...
    keys_to_features = {
         ...
         # 'image_raw_A_seg' : tf.FixedLenFeature([], tf.string),
         # 'image_raw_B_seg' : tf.FixedLenFeature([], tf.string),
         # 'image_raw_A_seg_class' : tf.FixedLenFeature([], tf.string),
         # 'image_raw_B_seg_class' : tf.FixedLenFeature([], tf.string),
         ...
         # 'A_seg_valid': tf.FixedLenFeature([], tf.int64),
         # 'B_seg_valid': tf.FixedLenFeature([], tf.int64),
    }
    ...
    items_to_handlers = {
        ...
        # 'image_raw_A_seg': slim.tfexample_decoder.Image(image_key='image_raw_A_seg', shape=[img_height, img_width, 3], channels=3, format_key='image_format'),
        # 'image_raw_B_seg': slim.tfexample_decoder.Image(image_key='image_raw_B_seg', shape=[img_height, img_width, 3], channels=3, format_key='image_format'),

        # 'image_raw_A_seg_class': slim.tfexample_decoder.Image(image_key='image_raw_A_seg_class', shape=[img_height, img_width, 1], channels=1, format_key='image_format'),
        # 'image_raw_B_seg_class': slim.tfexample_decoder.Image(image_key='image_raw_B_seg_class', shape=[img_height, img_width, 1], channels=1, format_key='image_format'),
        # 'A_seg_valid': slim.tfexample_decoder.Tensor('A_seg_valid'),
        # 'B_seg_valid': slim.tfexample_decoder.Tensor('B_seg_valid'),
    }
