...
if __name__ == '__main__':
    split_name = 'test_seq'
    dataset_dir = '/esat/dragon/liqianma/datasets/Adaptation/SG-GAN_data/gta_city_test_seq/'
    exemplar_img_name = 'frankfurt_000001_008200.png'
    save_sub_dir = 'gta_city_{}_{}x{}_{}'.format(split_name, _IMG_HEIGHT, _IMG_WEIGHT, exemplar_img_name.split('.')[0])
