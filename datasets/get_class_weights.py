...
def ENet_weighing(image_files, num_classes=20):
    '''
...
def median_frequency_balancing(image_files, num_classes=20):
    '''
...
if __name__ == "__main__":
    ...
    image_dir = "/esat/dragon/liqianma/datasets/Adaptation/SG-GAN_data/gta25k/trainA_seg_class_20trainId"
    ...
    print median_frequency_balancing(image_files, num_classes=20)
    print ENet_weighing(image_files, num_classes=20)